...
public class ActiveHighlight {
    ...
    // Targeting
    public enum TargetType { LOCAL_PLAYER, PLAYER_NAME, NPC_NAME, NPC_ID, TARGET, FRIEND_LIST, IGNORE_LIST, PARTY_MEMBERS, FRIENDS_CHAT, TEAM_MEMBERS, CLAN_MEMBERS, OTHERS, PLAYER_SPAWN, INTERACTION, ITEM_SPAWN }
